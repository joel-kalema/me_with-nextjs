    ...
    return(
        <div id='contact' className="flex justify-center flex-col items-center px-10 md:px-20 lg:px-60 pt-20" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="flex flex-col md:flex-row justify-between mt-20">
                <div className="w-full md:w-1/4 lg:w-2/4 text-sm lg:text-xl" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className="w-full md:w-3/5 lg:w-2/5 bg-[#1b212f] p-12 mb-[-13rem] shadow-xl" data-aos="fade-up" data-aos-duration="2000">
                    <form>
