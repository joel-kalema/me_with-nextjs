...
export default function Area (){
    ...
    return (
        <div className='px-8 md:20 lg:px-60 py-20 text-center relative' data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className='flex flex-col md:flex-row justify-around mt-12 w-[90%] mx-auto z-50'>
                {expertise.map((item) => (
                    <div className='py-6 px-12 w-full mt-8 md:w-[32%] flex flex-col justify-center bg-[#1b212f] shadow-2xl' data-aos="fade-up" data-aos-duration="1000">
